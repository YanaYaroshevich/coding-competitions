...
monkeysState[0].operation = (old) => { return (BigInt(old) * BigInt(5)) % nok; };
monkeysState[1].operation = (old) => { return (BigInt(old) + BigInt(3)) % nok; };
monkeysState[2].operation = (old) => { return (BigInt(old) + BigInt(7)) % nok; };
monkeysState[3].operation = (old) => { return (BigInt(old) + BigInt(5)) % nok; };
monkeysState[4].operation = (old) => { return (BigInt(old) + BigInt(2)) % nok; };
monkeysState[5].operation = (old) => { return (BigInt(old) * BigInt(19)) % nok; };
monkeysState[6].operation = (old) => { return (BigInt(old) * BigInt(old)) % nok; };
monkeysState[7].operation = (old) => { return (BigInt(old) + BigInt(4)) % nok; };
